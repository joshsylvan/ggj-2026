...
const GAME_START_COUNTDOWN_DURATION = 1000; // 3 second countdown before game starts
const COUNTDOWN_START_DELAY = 10; // 2 seconds before countdown starts
const COUNTDOWN_DURATION = 10; // 3 second countdown
